...
defmodule Envoy.Admin.V4alpha.ServerInfo do
  ...
  @type t :: %__MODULE__{
          version: String.t(),
          state: Envoy.Admin.V4alpha.ServerInfo.State.t(),
          ...
          command_line_options: Envoy.Admin.V4alpha.CommandLineOptions.t() | nil,
...
defmodule Envoy.Admin.V4alpha.CommandLineOptions do
  ...
  @type t :: %__MODULE__{
          ...
          local_address_ip_version: Envoy.Admin.V4alpha.CommandLineOptions.IpVersion.t(),
          log_level: String.t(),
          ...
          drain_strategy: Envoy.Admin.V4alpha.CommandLineOptions.DrainStrategy.t(),
          parent_shutdown_time: Google.Protobuf.Duration.t() | nil,
          mode: Envoy.Admin.V4alpha.CommandLineOptions.Mode.t(),
