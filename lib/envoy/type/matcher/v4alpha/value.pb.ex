...
defmodule Envoy.Type.Matcher.V4alpha.ValueMatcher do
  ...
  field :double_match, 2, type: Envoy.Type.Matcher.V4alpha.DoubleMatcher, oneof: 0
  field :string_match, 3, type: Envoy.Type.Matcher.V4alpha.StringMatcher, oneof: 0
  field :bool_match, 4, type: :bool, oneof: 0
  field :present_match, 5, type: :bool, oneof: 0
  field :list_match, 6, type: Envoy.Type.Matcher.V4alpha.ListMatcher, oneof: 0
end
