defmodule Envoy.Extensions.Filters.Http.Oauth2.V4alpha.OAuth2Credentials do
  @moduledoc false
...
defmodule Envoy.Extensions.Filters.Http.Oauth2.V4alpha.OAuth2Config do
  ...
  field :credentials, 3, type: Envoy.Extensions.Filters.Http.Oauth2.V4alpha.OAuth2Credentials
  field :redirect_uri, 4, type: :string
  field :redirect_path_matcher, 5, type: Envoy.Type.Matcher.V4alpha.PathMatcher
  field :signout_path, 6, type: Envoy.Type.Matcher.V4alpha.PathMatcher
  field :forward_bearer_token, 7, type: :bool
  field :pass_through_matcher, 8, repeated: true, type: Envoy.Config.Route.V4alpha.HeaderMatcher
