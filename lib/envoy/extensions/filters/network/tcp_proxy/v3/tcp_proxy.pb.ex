...
defmodule Envoy.Extensions.Filters.Network.TcpProxy.V3.TcpProxy.WeightedCluster do
  ...
  @type t :: %__MODULE__{
          clusters: [
            Envoy.Extensions.Filters.Network.TcpProxy.V3.TcpProxy.WeightedCluster.ClusterWeight.t()
          ]
        }
  defstruct [:clusters]
...
defmodule Envoy.Extensions.Filters.Network.TcpProxy.V3.TcpProxy do
  ...
  @type t :: %__MODULE__{
          ...
          tunneling_config:
            Envoy.Extensions.Filters.Network.TcpProxy.V3.TcpProxy.TunnelingConfig.t() | nil,
