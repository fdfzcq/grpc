defmodule Envoy.Extensions.Filters.Network.DubboProxy.V3.RouteConfiguration do
  ...
  @type t :: %__MODULE__{
          ...
          group: String.t(),
          version: String.t(),
          routes: [Envoy.Extensions.Filters.Network.DubboProxy.V3.Route.t()]
        }
...
defmodule Envoy.Extensions.Filters.Network.DubboProxy.V3.Route do
  ...
  @type t :: %__MODULE__{
          match: Envoy.Extensions.Filters.Network.DubboProxy.V3.RouteMatch.t() | nil,
          route: Envoy.Extensions.Filters.Network.DubboProxy.V3.RouteAction.t() | nil
        }
...
defmodule Envoy.Extensions.Filters.Network.DubboProxy.V3.RouteMatch do
  ...
  @type t :: %__MODULE__{
          method: Envoy.Extensions.Filters.Network.DubboProxy.V3.MethodMatch.t() | nil,
...
defmodule Envoy.Extensions.Filters.Network.DubboProxy.V3.MethodMatch.ParamsMatchEntry do
  ...
  @type t :: %__MODULE__{
          key: non_neg_integer,
          value:
            Envoy.Extensions.Filters.Network.DubboProxy.V3.MethodMatch.ParameterMatchSpecifier.t()
            | nil
        }
  defstruct [:key, :value]
...
defmodule Envoy.Extensions.Filters.Network.DubboProxy.V3.MethodMatch do
  ...
  @type t :: %__MODULE__{
          name: Envoy.Type.Matcher.V3.StringMatcher.t() | nil,
          params_match: %{
            non_neg_integer =>
              Envoy.Extensions.Filters.Network.DubboProxy.V3.MethodMatch.ParameterMatchSpecifier.t()
              | nil
