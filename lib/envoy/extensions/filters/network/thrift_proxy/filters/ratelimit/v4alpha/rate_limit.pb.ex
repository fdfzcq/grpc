defmodule Envoy.Extensions.Filters.Network.ThriftProxy.Filters.Ratelimit.V4alpha.RateLimit do
  @moduledoc false
  ...
  field :rate_limit_service, 5, type: Envoy.Config.Ratelimit.V4alpha.RateLimitServiceConfig
end
