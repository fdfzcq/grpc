...
defmodule Envoy.Config.Metrics.V4alpha.StatsConfig do
  ...
  @type t :: %__MODULE__{
          stats_tags: [Envoy.Config.Metrics.V4alpha.TagSpecifier.t()],
          use_all_default_tags: Google.Protobuf.BoolValue.t() | nil,
          stats_matcher: Envoy.Config.Metrics.V4alpha.StatsMatcher.t() | nil,
          histogram_bucket_settings: [Envoy.Config.Metrics.V4alpha.HistogramBucketSettings.t()]
        }
...
defmodule Envoy.Config.Metrics.V4alpha.HistogramBucketSettings do
  ...
  @type t :: %__MODULE__{
          match: Envoy.Type.Matcher.V4alpha.StringMatcher.t() | nil,
