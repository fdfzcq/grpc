...
defmodule Envoy.Config.Cluster.V4alpha.Cluster.EdsClusterConfig do
  ...
  @type t :: %__MODULE__{
          eds_config: Envoy.Config.Core.V4alpha.ConfigSource.t() | nil,
...
defmodule Envoy.Config.Cluster.V4alpha.Cluster.LbSubsetConfig.LbSubsetSelector do
  ...
  @type t :: %__MODULE__{
          ...
          fallback_policy:
            Envoy.Config.Cluster.V4alpha.Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicy.t(),
...
defmodule Envoy.Config.Cluster.V4alpha.Cluster.LbSubsetConfig do
  ...
  @type t :: %__MODULE__{
          fallback_policy:
            Envoy.Config.Cluster.V4alpha.Cluster.LbSubsetConfig.LbSubsetFallbackPolicy.t(),
          default_subset: Google.Protobuf.Struct.t() | nil,
          subset_selectors: [
            Envoy.Config.Cluster.V4alpha.Cluster.LbSubsetConfig.LbSubsetSelector.t()
          ],
...
defmodule Envoy.Config.Cluster.V4alpha.Cluster.LeastRequestLbConfig do
  ...
  @type t :: %__MODULE__{
          ...
          active_request_bias: Envoy.Config.Core.V4alpha.RuntimeDouble.t() | nil
        }
...
defmodule Envoy.Config.Cluster.V4alpha.Cluster.RingHashLbConfig do
  ...
  @type t :: %__MODULE__{
          ...
          hash_function: Envoy.Config.Cluster.V4alpha.Cluster.RingHashLbConfig.HashFunction.t(),
...
defmodule Envoy.Config.Cluster.V4alpha.Cluster.CommonLbConfig do
  ...
  @type t :: %__MODULE__{
          ...
          consistent_hashing_lb_config:
            Envoy.Config.Cluster.V4alpha.Cluster.CommonLbConfig.ConsistentHashingLbConfig.t()
            | nil
        }
  defstruct [
...
defmodule Envoy.Config.Cluster.V4alpha.Cluster do
  ...
  @type t :: %__MODULE__{
          ...
          eds_cluster_config: Envoy.Config.Cluster.V4alpha.Cluster.EdsClusterConfig.t() | nil,
          connect_timeout: Google.Protobuf.Duration.t() | nil,
          per_connection_buffer_limit_bytes: Google.Protobuf.UInt32Value.t() | nil,
          lb_policy: Envoy.Config.Cluster.V4alpha.Cluster.LbPolicy.t(),
          ...
          circuit_breakers: Envoy.Config.Cluster.V4alpha.CircuitBreakers.t() | nil,
          typed_extension_protocol_options: %{String.t() => Google.Protobuf.Any.t() | nil},
          dns_refresh_rate: Google.Protobuf.Duration.t() | nil,
          dns_failure_refresh_rate: Envoy.Config.Cluster.V4alpha.Cluster.RefreshRate.t() | nil,
          respect_dns_ttl: boolean,
          dns_lookup_family: Envoy.Config.Cluster.V4alpha.Cluster.DnsLookupFamily.t(),
          dns_resolvers: [Envoy.Config.Core.V4alpha.Address.t()],
          use_tcp_for_dns_lookups: boolean,
          outlier_detection: Envoy.Config.Cluster.V4alpha.OutlierDetection.t() | nil,
          cleanup_interval: Google.Protobuf.Duration.t() | nil,
          upstream_bind_config: Envoy.Config.Core.V4alpha.BindConfig.t() | nil,
          lb_subset_config: Envoy.Config.Cluster.V4alpha.Cluster.LbSubsetConfig.t() | nil,
          common_lb_config: Envoy.Config.Cluster.V4alpha.Cluster.CommonLbConfig.t() | nil,
          transport_socket: Envoy.Config.Core.V4alpha.TransportSocket.t() | nil,
          metadata: Envoy.Config.Core.V4alpha.Metadata.t() | nil,
          upstream_connection_options:
            Envoy.Config.Cluster.V4alpha.UpstreamConnectionOptions.t() | nil,
          close_connections_on_host_health_failure: boolean,
          ignore_health_on_host_removal: boolean,
          filters: [Envoy.Config.Cluster.V4alpha.Filter.t()],
          load_balancing_policy: Envoy.Config.Cluster.V4alpha.LoadBalancingPolicy.t() | nil,
          lrs_server: Envoy.Config.Core.V4alpha.ConfigSource.t() | nil,
          upstream_config: Envoy.Config.Core.V4alpha.TypedExtensionConfig.t() | nil,
          track_cluster_stats: Envoy.Config.Cluster.V4alpha.TrackClusterStats.t() | nil,
          preconnect_policy: Envoy.Config.Cluster.V4alpha.Cluster.PreconnectPolicy.t() | nil,
  ...
  field :maglev_lb_config, 52, type: Envoy.Config.Cluster.V4alpha.Cluster.MaglevLbConfig, oneof: 1
...
defmodule Envoy.Config.Cluster.V4alpha.LoadBalancingPolicy do
  ...
  @type t :: %__MODULE__{
          policies: [Envoy.Config.Cluster.V4alpha.LoadBalancingPolicy.Policy.t()]
        }
  defstruct [:policies]
...
defmodule Envoy.Config.Cluster.V4alpha.UpstreamBindConfig do
  ...
  @type t :: %__MODULE__{
          source_address: Envoy.Config.Core.V4alpha.Address.t() | nil
        }
...
defmodule Envoy.Config.Cluster.V4alpha.UpstreamConnectionOptions do
  ...
  @type t :: %__MODULE__{
          tcp_keepalive: Envoy.Config.Core.V4alpha.TcpKeepalive.t() | nil
        }
