...
defmodule Envoy.Config.Core.V4alpha.SocketAddress do
  ...
  @type t :: %__MODULE__{
          ...
          protocol: Envoy.Config.Core.V4alpha.SocketAddress.Protocol.t(),
          address: String.t(),
...
defmodule Envoy.Config.Core.V4alpha.BindConfig do
  ...
  @type t :: %__MODULE__{
          source_address: Envoy.Config.Core.V4alpha.SocketAddress.t() | nil,
...
defmodule Envoy.Config.Core.V4alpha.Address do
  ...
  field :envoy_internal_address, 3, type: Envoy.Config.Core.V4alpha.EnvoyInternalAddress, oneof: 0
end
