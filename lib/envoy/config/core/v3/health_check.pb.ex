...
defmodule Envoy.Config.Core.V3.HealthCheck.HttpHealthCheck do
  ...
  @type t :: %__MODULE__{
          ...
          receive: Envoy.Config.Core.V3.HealthCheck.Payload.t() | nil,
  ...
  field :receive, 4, type: Envoy.Config.Core.V3.HealthCheck.Payload
  ...
  field :service_name_matcher, 11, type: Envoy.Type.Matcher.V3.StringMatcher
end
...
defmodule Envoy.Config.Core.V3.HealthCheck do
  ...
  field :http_health_check, 8, type: Envoy.Config.Core.V3.HealthCheck.HttpHealthCheck, oneof: 0
  field :tcp_health_check, 9, type: Envoy.Config.Core.V3.HealthCheck.TcpHealthCheck, oneof: 0
  field :grpc_health_check, 11, type: Envoy.Config.Core.V3.HealthCheck.GrpcHealthCheck, oneof: 0
  ...
  field :event_service, 22, type: Envoy.Config.Core.V3.EventServiceConfig
  field :always_log_health_check_failures, 19, type: :bool
  field :tls_options, 21, type: Envoy.Config.Core.V3.HealthCheck.TlsOptions
