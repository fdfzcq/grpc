defmodule Envoy.Data.Dns.V4alpha.DnsTable.AddressList do
  @moduledoc false
...
defmodule Envoy.Data.Dns.V4alpha.DnsTable.DnsService do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field :targets, 4, repeated: true, type: Envoy.Data.Dns.V4alpha.DnsTable.DnsServiceTarget
end

defmodule Envoy.Data.Dns.V4alpha.DnsTable.DnsServiceList do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Envoy.Data.Dns.V4alpha.DnsTable.DnsEndpoint do
  ...
  field :cluster_name, 2, type: :string, oneof: 0
  field :service_list, 3, type: Envoy.Data.Dns.V4alpha.DnsTable.DnsServiceList, oneof: 0
end

defmodule Envoy.Data.Dns.V4alpha.DnsTable.DnsVirtualDomain do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Envoy.Data.Dns.V4alpha.DnsTable do
  ...
  field :virtual_domains, 2,
    repeated: true,
    type: Envoy.Data.Dns.V4alpha.DnsTable.DnsVirtualDomain

  field :known_suffixes, 3, repeated: true, type: Envoy.Type.Matcher.V4alpha.StringMatcher
end
