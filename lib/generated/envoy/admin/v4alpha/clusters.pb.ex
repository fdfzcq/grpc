defmodule Envoy.Admin.V4alpha.Clusters do
  ...
  @type t :: %__MODULE__{
          cluster_statuses: [Envoy.Admin.V4alpha.ClusterStatus.t()]
        }
...
defmodule Envoy.Admin.V4alpha.ClusterStatus do
  ...
  @type t :: %__MODULE__{
          ...
          host_statuses: [Envoy.Admin.V4alpha.HostStatus.t()],
...
defmodule Envoy.Admin.V4alpha.HostStatus do
  ...
  @type t :: %__MODULE__{
          ...
          stats: [Envoy.Admin.V4alpha.SimpleMetric.t()],
          health_status: Envoy.Admin.V4alpha.HostHealthStatus.t() | nil,
...
defmodule Envoy.Admin.V4alpha.HostHealthStatus do
  ...
  @type t :: %__MODULE__{
          ...
          eds_health_status: Envoy.Config.Core.V4alpha.HealthStatus.t()
        }
  defstruct [
