defmodule Envoy.Admin.V4alpha.Certificates do
  @moduledoc false
...
defmodule Envoy.Admin.V4alpha.CertificateDetails.OcspDetails do
  @moduledoc false
  use Protobuf, syntax: :proto3
...
defmodule Envoy.Admin.V4alpha.CertificateDetails do
  ...
  field :subject_alt_names, 3, repeated: true, type: Envoy.Admin.V4alpha.SubjectAlternateName
  ...
  field :ocsp_details, 7, type: Envoy.Admin.V4alpha.CertificateDetails.OcspDetails
end
