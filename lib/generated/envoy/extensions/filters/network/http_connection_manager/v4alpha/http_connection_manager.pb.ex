...
defmodule Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpConnectionManager.Tracing do
  ...
  @type t :: %__MODULE__{
          ...
          provider: Envoy.Config.Trace.V4alpha.Tracing.Http.t() | nil
        }
  defstruct [
    :client_sampling,
    :random_sampling,
...
defmodule Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpConnectionManager.UpgradeConfig do
  ...
  @type t :: %__MODULE__{
          ...
          filters: [Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpFilter.t()],
...
defmodule Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpConnectionManager do
  ...
  @type t :: %__MODULE__{
          ...
          codec_type:
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpConnectionManager.CodecType.t(),
          stat_prefix: String.t(),
          http_filters: [
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpFilter.t()
          ],
          add_user_agent: Google.Protobuf.BoolValue.t() | nil,
          tracing:
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpConnectionManager.Tracing.t()
            | nil,
          common_http_protocol_options: Envoy.Config.Core.V4alpha.HttpProtocolOptions.t() | nil,
          http_protocol_options: Envoy.Config.Core.V4alpha.Http1ProtocolOptions.t() | nil,
          http2_protocol_options: Envoy.Config.Core.V4alpha.Http2ProtocolOptions.t() | nil,
          server_name: String.t(),
          server_header_transformation:
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpConnectionManager.ServerHeaderTransformation.t(),
          ...
          internal_address_config:
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpConnectionManager.InternalAddressConfig.t()
            | nil,
          ...
          forward_client_cert_details:
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpConnectionManager.ForwardClientCertDetails.t(),
          set_current_client_cert_details:
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpConnectionManager.SetCurrentClientCertDetails.t()
            | nil,
          proxy_100_continue: boolean,
          represent_ipv4_remote_address_as_ipv4_mapped_ipv6: boolean,
          upgrade_configs: [
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.HttpConnectionManager.UpgradeConfig.t()
          ],
          normalize_path: Google.Protobuf.BoolValue.t() | nil,
          merge_slashes: boolean,
          request_id_extension:
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.RequestIDExtension.t()
            | nil,
          local_reply_config:
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.LocalReplyConfig.t()
            | nil,
...
defmodule Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.LocalReplyConfig do
  ...
  @type t :: %__MODULE__{
          mappers: [
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.ResponseMapper.t()
          ],
          body_format: Envoy.Config.Core.V4alpha.SubstitutionFormatString.t() | nil
        }
...
defmodule Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.ResponseMapper do
  ...
  @type t :: %__MODULE__{
          ...
          body_format_override: Envoy.Config.Core.V4alpha.SubstitutionFormatString.t() | nil,
...
defmodule Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.Rds do
  ...
  @type t :: %__MODULE__{
          config_source: Envoy.Config.Core.V4alpha.ConfigSource.t() | nil,
...
defmodule Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.ScopedRouteConfigurationsList do
  ...
  @type t :: %__MODULE__{
          scoped_route_configurations: [Envoy.Config.Route.V4alpha.ScopedRouteConfiguration.t()]
        }
...
defmodule Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.ScopedRoutes.ScopeKeyBuilder do
  ...
  @type t :: %__MODULE__{
          fragments: [
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.ScopedRoutes.ScopeKeyBuilder.FragmentBuilder.t()
          ]
        }
  defstruct [:fragments]
...
defmodule Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.ScopedRoutes do
  ...
  @type t :: %__MODULE__{
          ...
          name: String.t(),
          scope_key_builder:
            Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.ScopedRoutes.ScopeKeyBuilder.t()
            | nil,
          rds_config_source: Envoy.Config.Core.V4alpha.ConfigSource.t() | nil
        }
...
defmodule Envoy.Extensions.Filters.Network.HttpConnectionManager.V4alpha.ScopedRds do
  ...
  @type t :: %__MODULE__{
          scoped_rds_config_source: Envoy.Config.Core.V4alpha.ConfigSource.t() | nil
        }
