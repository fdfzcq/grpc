...
defmodule Envoy.Config.Core.V3.ApiConfigSource do
  ...
  @type t :: %__MODULE__{
          api_type: Envoy.Config.Core.V3.ApiConfigSource.ApiType.t(),
          transport_api_version: Envoy.Config.Core.V3.ApiVersion.t(),
          cluster_names: [String.t()],
          grpc_services: [Envoy.Config.Core.V3.GrpcService.t()],
          refresh_delay: Google.Protobuf.Duration.t() | nil,
          request_timeout: Google.Protobuf.Duration.t() | nil,
          rate_limit_settings: Envoy.Config.Core.V3.RateLimitSettings.t() | nil,
  ...
  field :api_type, 1, type: Envoy.Config.Core.V3.ApiConfigSource.ApiType, enum: true
  field :transport_api_version, 8, type: Envoy.Config.Core.V3.ApiVersion, enum: true
  field :cluster_names, 2, repeated: true, type: :string
  field :grpc_services, 4, repeated: true, type: Envoy.Config.Core.V3.GrpcService
  field :refresh_delay, 3, type: Google.Protobuf.Duration
  field :request_timeout, 5, type: Google.Protobuf.Duration
  field :rate_limit_settings, 6, type: Envoy.Config.Core.V3.RateLimitSettings
...
defmodule Envoy.Config.Core.V3.SelfConfigSource do
  ...
  field :transport_api_version, 1, type: Envoy.Config.Core.V3.ApiVersion, enum: true
end
...
defmodule Envoy.Config.Core.V3.ConfigSource do
  ...
  @type t :: %__MODULE__{
          ...
          resource_api_version: Envoy.Config.Core.V3.ApiVersion.t()
        }
  defstruct [
  ...
  field :api_config_source, 2, type: Envoy.Config.Core.V3.ApiConfigSource, oneof: 0
  ...
  field :resource_api_version, 6, type: Envoy.Config.Core.V3.ApiVersion, enum: true
end
