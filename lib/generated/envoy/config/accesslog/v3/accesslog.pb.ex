...
defmodule Envoy.Config.Accesslog.V3.ComparisonFilter do
  ...
  @type t :: %__MODULE__{
          op: Envoy.Config.Accesslog.V3.ComparisonFilter.Op.t(),
          value: Envoy.Config.Core.V3.RuntimeUInt32.t() | nil
        }
  defstruct [:op, :value]
...
defmodule Envoy.Config.Accesslog.V3.StatusCodeFilter do
  ...
  @type t :: %__MODULE__{
          comparison: Envoy.Config.Accesslog.V3.ComparisonFilter.t() | nil
        }
...
defmodule Envoy.Config.Accesslog.V3.AndFilter do
  ...
  @type t :: %__MODULE__{
          filters: [Envoy.Config.Accesslog.V3.AccessLogFilter.t()]
        }
  defstruct [:filters]
...
defmodule Envoy.Config.Accesslog.V3.HeaderFilter do
  ...
  @type t :: %__MODULE__{
          header: Envoy.Config.Route.V3.HeaderMatcher.t() | nil
        }
  defstruct [:header]
...
defmodule Envoy.Config.Accesslog.V3.GrpcStatusFilter do
  ...
  @type t :: %__MODULE__{
          statuses: [[Envoy.Config.Accesslog.V3.GrpcStatusFilter.Status.t()]],
          exclude: boolean
        }
