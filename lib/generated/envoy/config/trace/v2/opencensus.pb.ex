...
defmodule Envoy.Config.Trace.V2.OpenCensusConfig do
  ...
  @type t :: %__MODULE__{
          ...
          stackdriver_grpc_service: Envoy.Api.V2.Core.GrpcService.t() | nil,
          zipkin_exporter_enabled: boolean,
          zipkin_url: String.t(),
          ocagent_exporter_enabled: boolean,
          ocagent_address: String.t(),
          ocagent_grpc_service: Envoy.Api.V2.Core.GrpcService.t() | nil,
          incoming_trace_context: [[Envoy.Config.Trace.V2.OpenCensusConfig.TraceContext.t()]],
          outgoing_trace_context: [[Envoy.Config.Trace.V2.OpenCensusConfig.TraceContext.t()]]
        }
  defstruct [
    :trace_config,
